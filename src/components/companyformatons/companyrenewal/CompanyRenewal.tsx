  ...
  return (
    <div className='container mx-auto pt-10'>
      <div className='grid grid-cols-2 gap-10'>
        <div>
          <Overview title={"Why change agent?"} desc={"When you first incorporate an offshore company, you start with tax planning and legal matters. This does not mean you will not have any issues in the future. Issues may not just be related to finances, they may relate to supporting, maintaining and advising your company from year to year and dealing with some matters during the life of your business. You have to choose the proper provider or registered agent to serve your offshore structure during its lifetime."} image={''}/>
          <div className='pt-5'>
          <Overview title={"Why change agent?"} desc={"When you first incorporate an offshore company, you start with tax planning and legal matters. This does not mean you will not have any issues in the future. Issues may not just be related to finances, they may relate to supporting, maintaining and advising your company from year to year and dealing with some matters during the life of your business. You have to choose the proper provider or registered agent to serve your offshore structure during its lifetime."} image={''}/>
          </div>
        </div>
