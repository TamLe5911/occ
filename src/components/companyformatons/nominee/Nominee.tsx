...
function Nominee() {
  return (
    <div className='bg-white'>
        <div className='pt-10 '>
        <div className='grid grid-cols-2 pt-5 gap-10 container mx-auto'>
          <div>
            <Overview image='/share/icon-features.svg' title={"Features of Nominee Service"} desc={"A Nominee service is a legal way of protecting the identity and anonymity of the company owner. The main function of nominee directors or shareholders is to maintain the anonymity of the real owner by taking their place in all public records relating to the company and non-governmental bodies."}/>
          </div>
        ...
        <div className='pt-10 container mx-auto'>
          <NomineeServiceWork Icon3={"/share/icon-receive.png"}  Icon1={"/share/icon-provide.png"} Icon2={"/share/icon-finish.png"} Icon4={"/share/icon-setting.svg"}
