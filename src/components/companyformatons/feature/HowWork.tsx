      ...
      <div className="container mx-auto">
        <div className="relative pt-10 text-white ">
          ...
          <div className="text-center mt-5 mb-5">
            Find out everything you need to start an offshore business. It’s
            simple, fast and effective. Our dedicated experts is here to support
            you through all the processes. Set up at Offshore Company Corp now
            in just 4 easy steps.
          </div>
          <div className=" mt-5 text-center">
            <ViewAll titlemore={"View all"}></ViewAll>
          </div>
        </div>
      </div>
    </div>
