...
function ChangeAgent() {
  return (
    <div className="container mx-auto pt-10">
      ...
      <div className="py-10">
        <ChangeServiceWork
          Icon3={"/share/icon-change-step3.png"}
          Icon1={"/share/icon-provide.png"}
          Icon2={"/share/icon-finish.png"}
      ...
      <div className="pt-4">
        <p className="text-base">
          <strong>Notes:</strong> Services fee is not including outstanding fee
          which you not yet paid for previous years, penalty, annual fee or
          other services like Nominee or Annual return - if any.
        </p>
